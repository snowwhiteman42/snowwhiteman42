...
**PhD chemist → applied AI & data analysis.** I evaluate and build with large
language models, design prompting and AI workflows, and automate data work in Python.

🔬 9+ years turning complex, multi-source data into clear conclusions.
🤖 Now focused on **applied AI**: LLM evaluation, prompt engineering, MCP workflows, Python automation.
